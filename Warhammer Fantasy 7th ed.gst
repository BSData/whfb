...
<gameSystem id="779f-c127-a94a-bf00" name="Warhammer Fantasy 7th ed" revision="1" battleScribeVersion="2.03" authorName="WipeOut" authorContact="wipeout.htc2011@gmail.com" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <costTypes>
    <costType id="eaa7-6800-e651-8bea" name="pts" defaultCostLimit="-1.0"/>
  </costTypes>
  <profileTypes>
    <profileType id="3b8e-59e2-c690-f5b1" name="Infantery">
      <characteristicTypes>
        <characteristicType id="ec17-59b5-5187-086f" name="New CharacteristicType"/>
      </characteristicTypes>
    </profileType>
  </profileTypes>
  <categoryEntries>
    ...
    <forceEntry id="5f75-906f-4d23-7a30" name="Warhammer Fantasy 7th Edition" hidden="false">
      <categoryLinks>
        <categoryLink id="f2d7-f8a2-7e14-ef5e" name="Core" hidden="false" targetId="62d3-efc6-6c2c-634e" primary="false">
          <modifierGroups>
            <modifierGroup>
              <modifiers>
                ...
                <modifier type="set" field="98ab-f7f1-5fb5-18c3" value="2.0">
                  <conditionGroups>
                    <conditionGroup type="or">
                      <conditions>
                        <condition field="limit::eaa7-6800-e651-8bea" scope="roster" value="2000.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="model" type="lessThan"/>
                        <condition field="limit::eaa7-6800-e651-8bea" scope="roster" value="-1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="model" type="equalTo"/>
                      </conditions>
                    </conditionGroup>
                  </conditionGroups>
                </modifier>
          ...
          <constraints>
            <constraint field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" id="98ab-f7f1-5fb5-18c3" type="min"/>
          </constraints>
        </categoryLink>
        <categoryLink id="1821-b8e0-2aa1-b805" name="Characters" hidden="false" targetId="48f1-4778-a9db-cde7" primary="false">
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" id="562f-9770-dc82-1b05" type="max"/>
          </constraints>
        </categoryLink>
        ...
        <categoryLink id="b6e8-eda4-372a-43dd" name="Rare" hidden="false" targetId="a3af-995e-0cf1-7091" primary="false">
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" id="abcb-d080-e34a-9d53" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="abaa-abc3-5162-6a22" name="Special" hidden="false" targetId="4a3f-84d1-0495-6ecb" primary="false">
          ...
          <constraints>
            <constraint field="selections" scope="parent" value="2.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" id="f140-733f-991c-4d18" type="max"/>
          </constraints>
        </categoryLink>
  ...
  <sharedSelectionEntries>
    <selectionEntry id="52c3-25b3-e386-3449" name="Dispell Scroll" hidden="false" collective="false" import="true" type="upgrade">
      <costs>
        <cost name="pts" typeId="eaa7-6800-e651-8bea" value="25.0"/>
      </costs>
    </selectionEntry>
    <selectionEntry id="f775-63f2-a2cf-48c4" name="Power Stone" hidden="false" collective="false" import="true" type="upgrade">
      <costs>
        <cost name="pts" typeId="eaa7-6800-e651-8bea" value="20.0"/>
      </costs>
    </selectionEntry>
    <selectionEntry id="0871-b449-88b1-0a33" name="Staff of Sorcery" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="4a2b-c497-93f2-c804" name="Enchanted Shield" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="862d-4fba-1966-3f2f" name="Warbanner" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="3c3e-b471-60a2-bcb5" name="Biting Blade" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="73d1-55d2-43ea-a386" name="Sword of Battle" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="3c1d-e820-ab6f-4ea1" name="Sword of Might" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="546d-e9a9-3084-27c1" name="Sword of Striking" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="0187-c1bd-3c63-16b4" name="Talisman of Protection" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="eca1-46d6-8778-847f" name="Battle Standard Bearer" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
  ...
  <sharedRules>
    <rule id="ad62-f73e-08d3-3236" name="Infantery" hidden="false"/>
  </sharedRules>
  <sharedProfiles>
    <profile id="080e-7dca-df7f-c99c" name="Infantery" hidden="false" typeId="3b8e-59e2-c690-f5b1" typeName="Infantery">
      <characteristics>
        <characteristic name="New CharacteristicType" typeId="ec17-59b5-5187-086f"/>
      </characteristics>
    </profile>
  </sharedProfiles>
</gameSystem>